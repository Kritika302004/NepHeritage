...
const setCookies = (res, accessToken, refreshToken) => {
    res.cookie("accessToken", accessToken, {
        httpOnly: true, //preverts XSS attacks, makes it secures by using httpOnly,cross site scripting attack
        ...
        if(user && (await user.comparePassword(password))){
            ...
            res.json({
                ...
                message: "Login scuccessfully"
                 ...
                 res.status(500).json({message: "Invalid eamil or password"});
            }
